...
'controller_not_found' 	=> array( 'Nie odnaleziono kontrolera.', '<strong>Nazwa:</strong> %s<br /><strong>Aplikacja:</strong> %s<br /><strong>Przeszukane lokalizacje:</strong> <pre>%s</pre>' ),
