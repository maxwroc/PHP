...
window.onload = function () {
    ...
    label.hide();
    var frame = r.popup(100, 100, label, "right").attr({fill: "lightgray", stroke: "#000", "stroke-width": 2, "fill-opacity": .7}).hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        var dot = r.circle(x, y, 4).attr({fill: "lightgreen", stroke: color, "stroke-width": 2});
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: data + " load"}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
